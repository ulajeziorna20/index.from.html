...
// Nazwa: array.push()
// Parametry: (item1, item2....)
// Funkcja zwraca: nowa długość tablicy
// Opis działania: dodaje nowe elementy do końca tablicy.
...
let nowaDlugoscTablicy = filmy.push(`Iluzja`, `john Wick`);
